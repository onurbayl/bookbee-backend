...
describe('WishListController', () => {
    ...
    describe('/api/v1/wishList/get-items', () => {
    ...
    describe('/api/v1/wishList/remove-item/:bookId', () => {
        ...
        it('Success', async () => {
            ...
            const deleteItem = await request(app.getHttpServer())
            .delete('/api/v1/wishList/remove-item/12')
            .set('Authorization', `Bearer ${bearerToken}`)
            .expect(200);
    ...
    describe('/api/v1/wishList/add-item/:bookId', () => {
        ...
        it('Success', async () => {
            ...
            .post('/api/v1/wishList/add-item/1')
            .set('Authorization', `Bearer ${bearerToken}`)
            .expect(201);
